...
namespace SourceCode.SmartObjects.Services.Data
{
    ...
    class DataConnector : IDataConnector
    {
        ...
        public void SetupService()
        {
            ...
            string friendlyName = "ADO Query - " + configHostServerName + ":" + configHostServerPort;
        ...
        public void DescribeSchema()
        {
            ...
            foreach (Type t in types)
            {
                if (t.IsClass)
                {
                    ...
                    {
                        this.serviceBroker.Service.ServiceObjects.Create(new SourceCode.SmartObjects.Services.ServiceSDK.Objects.ServiceObject(t));
                    }
                }
            }
        }
